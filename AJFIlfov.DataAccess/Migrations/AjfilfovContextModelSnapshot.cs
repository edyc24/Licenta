...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AJFIlfov.Entities.Entities.CategoriiTurneu", b =>
                {
                    ...
                    b.ToTable("CategoriiTurneu", (string)null);
                });
            ...
            modelBuilder.Entity("AJFIlfov.Entities.Entities.Turnee", b =>
                {
                    b.Property<Guid>("IdTurneu")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("(newid())");
            ...
            modelBuilder.Entity("AJFIlfov.Entities.Entities.Turnee", b =>
                {
                    b.HasOne("AJFIlfov.Entities.Entities.CategoriiTurneu", "IdCategorieNavigation")
                        .WithMany("Turnee")
                        .HasForeignKey("IdCategorie")
                        .HasConstraintName("FK_Turnee_CategoriiTurneu");

                    b.HasOne("AJFIlfov.Entities.Entities.Echipe", "IdEchipaGazdaNavigation")
                        .WithMany("TurneeIdEchipaGazdaNavigation")
                        .HasForeignKey("IdEchipaGazda")
                        .HasConstraintName("FK_Turnee_Echipe_Gazda");

                    b.HasOne("AJFIlfov.Entities.Entities.Echipe", "IdEchipaOaspeteNavigation")
                        .WithMany("TurneeIdEchipaOaspeteNavigation")
                        .HasForeignKey("IdEchipaOaspete")
            ...
            modelBuilder.Entity("AJFIlfov.Entities.Entities.Echipe", b =>
                {
                    ...
                    b.Navigation("TurneeIdEchipaOaspeteNavigation");
                });
