...
public class StadionLocalitateController : BaseController
{
    ...
    public StadionLocalitateController(ControllerDependencies dependencies, StadionLocalitateService service,
        StadioaneService stadioaneService, LocalitatiService localitatiService)
        : base(dependencies)
    {
        _service = service;
